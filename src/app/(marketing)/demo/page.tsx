  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="bg-gradient-to-r from-fuchsia-600 via-purple-600 to-blue-600 text-center text-sm py-2.5 px-4">
        🎬 Estás viendo una demo. Así se ve una academia real en Curplat.{" "}
        <Link href="/signup" className="underline font-semibold hover:no-underline">
          Crear la tuya gratis →
        </Link>
      </div>

      {/* Storefront mock (estilo academia real) */}
      <div className="bg-white text-black">
          ...
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-black/50">Academia de Diseño UX</div>
              </div>
            </div>
            <nav className="hidden md:flex gap-6 text-sm">
              <a href="#" className="font-medium">Cursos</a>
        ...
        <section className="px-6 py-16 bg-gradient-to-b from-orange-50 to-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-black/60 max-w-xl mx-auto">
              Cursos pensados para diseñadores que quieren laburar en producto digital.
            </p>
        ...
        <section className="px-6 py-16">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold mb-8">Cursos disponibles</h2>
        ...
        <footer className="border-t border-black/10 px-6 py-8 text-center text-sm text-black/50">
          © 2026 Mariana Vega · Academia de Diseño UX
        </footer>
      </div>
