...
const items: CmdItem[] = [
  ...
  { id: 'nav-publicaciones', label: 'Mis publicaciones', group: 'Ir a', icon: '🛍️', href: '/mis-publicaciones', keywords: 'publicaciones ofertas products productos ventas ecommerce' },
